    ...
    <div className='bg-zinc-800 text-white h-screen flex justify-center items-center'>
      <div className='bg-zinc-900 p-8 rounded shadow-lg w-96'>
        ...
        <form className='flex flex-col'>
          <input type='text' placeholder='Username' className='mb-4 p-2 rounded bg-zinc-700 text-white' required />
          ...
          <button type='submit' className='bg-yellow-500 text-black p-2 rounded hover:bg-yellow-600'>Sign Up</button>
          </form> 
        <div className='mt-4 text-center'>
        <p className='text-gray-400'>Already have an account? <Link to='/login' className='text-yellow-500 hover:underline'>Login</Link></p>
      </div>
      </div> 
    </div>
  )
